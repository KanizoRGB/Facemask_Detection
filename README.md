...
## :file_folder: Dataset
The dataset used can be downloaded here - [Click to Download](https://github.com/KanizoRGB/Facemask_Detection/tree/master/dataset2)
...
All the dependencies and required libraries are included in the file <code>requirements.txt</code> [See here](https://github.com/KanizoRGB/Facemask_Detection/blob/main/requirements.txt)
